...
public interface CarToolBoxService {
     ...
     * @return
     */
    BizResult<List<SeriesDTO>> getVaildSeriesList(Long partnerId, Long brandId, Integer status);
     ...
     * @return
     */
    BizResult<List<BrandDTO>> getRecentBrandList(Long partnerId, Integer standard);

    // 管理员专用, 根据partnerId就可以限制权限
    BizResult<List<BrandDTO>> getVaildBrandListForAdminWithUserId(BrandListRequest brandListForm);

    // 普通用户专用, 根据userId、brandIds限制权限
    BizResult<List<BrandDTO>> getVaildBrandListForUser(Long partnerId, Integer status, Long userId, List<Long> brandIds);

    BizResult<List<SeriesDTO>> getVaildSeriesListForUser(Long partnerId, Long userId, Long brandId, Integer status);
     ...
     * @return
     */
    BizResult<List<SeriesDTO>> getVaildSeriesListForAdmin(SeriesRequest form);
