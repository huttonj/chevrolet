...
public class MyBatisGenConst {
    ...
    // 包名
    public static final String MAIN_PACKAGE = "com.chevrolet.dal.dao";
    public static final String DO_PACKAGE = "com.chevrolet.dal.dao.domain";
    public static final String QUERY_PACKAGE="com.chevrolet.dal.dao.domain.query";
    public static final String MAPPER_PACKAGE = "com.chevrolet.dal.dao.mapper";
    public static final String MANAGER_PACKAGE= "com.chevrolet.dal.dao.manager";
    public static final String MANAGER_IMPL_PACKAGE= "com.chevrolet.dal.dao.manager.impl";

    public static final String MAPPER_EXT_PACKAGE = "com.chevrolet.dal.dao.mapper.ext";
    public static final String TABLE_PREFIX = "b2b_|cc_|tms_";
    ...
    // mapper xml 输出目录
    public static final String MAPPER_XML_DIR = WORK_DIR + "chevrolet-dal/src/main/resources/mybatis";
    // mapper-ext xml 输出目录
    public static final String MAPPER_EXT_XML_DIR = WORK_DIR + "chevrolet-dal/src/main/resources/mybatis/ext/";
    // do/model 输出目录
    public static final String MAPPER_DO_DIR = WORK_DIR + "chevrolet-dal/src/main/java/com/chevrolet/dal/dao/domain";
    // query 输出目录
    public static final String MAPPER_QUERY_DIR = WORK_DIR + "chevrolet-dal/src/main/java/com/chevrolet/dal/dao/domain/query";
    // mapper java 输出目录
    public static final String MAPPER_JAVA_DIR = WORK_DIR + "chevrolet-dal/src/main/java/com/chevrolet/dal/dao/mapper";

    public static final String MANAGER_JAVA_DIR = WORK_DIR + "chevrolet-dal/src/main/java/com/chevrolet/dal/dao/manager";
    public static final String MANAGER_IMPL_JAVA_DIR = "chevrolet-dal/src/main/java/com/chevrolet/dal/dao/manager/impl";



    // mapper-ext java 输出目录
    public static final String MAPPER_EXT_JAVA_DIR = WORK_DIR + "chevrolet-dal/src/main/java/com/chevrolet/dal/dao/mapper/ext";
    // java数据对象类模板
