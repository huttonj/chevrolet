package com.chevrolet.core.wrapper;
...
public interface RedisWrapper {
    ...
    /**
     * 从redis中解析并返回对象，支持复杂类型
     * add by maihe 2017.05.25
     *
     * @param key
     * @param typeReference
     * @param <T>
     * @return
     */
    <T> T getObjectComplex(String key, TypeReference typeReference);
     ...
     * @return
     */
    void putAsync(String key, String json, int second);
     ...
     * @return
     */
    Collection<String> getKeys(PrefixEnum prefixEnum);
     ...
     * @return
     */
    Long addWithScore(String key, String value, long score);
     ...
     * @return
     */
    Long addWithScore(String key, String value, long score, int expireDays);
    ...
    //分布式锁，仅解决acquire问题，不包含CLH队列
    boolean lock(final String key, final int expire);

    boolean transactionActions(OptimisticLockCallback callback, String... key);

    interface OptimisticLockCallback {
